...
if pathes.data_mode == "kinematic":
    ...
    tracker_relevant_data = [(1, tracker_idx_col), (6, 'timestamp'), (29, 'Hand_loc_Z'),
                             (49, 'right_pupil'), (50, 'left_pupil'),(48, 'LastObject')]  # (48, 'LastObject')]
    to_drop = ['Hand_loc_Z']
...
relevant_questions_answers = [88, 666]
relevant_questions_answers_names = ['Agency', 'Confidence']
answers_file_name = "answers"
answer_question_col_name = "QuestionID"
answer_col_name = "QuestionResult"
answer_relevant_cols = [answer_col_name, answer_question_col_name]
...
relevant_question_trials = 88
trial_condition_col_name = "Condition"
...
# for ophir_pilot:trial_labels_dic = {(0,0): 0, (0.05,0): 1, (0.1,0):2, (0.15,0):3, (0.2,0):4}
# for ophir_replication:trial_labels_dic = {(0,0): 0, (0.05,0): 1, (0.105,0):2, (0.149,0):3, (0.204,0):4}


# reading files configuration
participant_dir_name = 'Sub'
numbers_mode = 3
experiment_name = 'Butterfly SoA'
